        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#services">Akademik</a></li>
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                ...
                <h2>Sistem Akademik<em> Universitas Mantapu</em><span> </span></h2>
                <p>Siakademik merupakan sistem informasi akademik Universitas Mantapu yang berfokus pada pelayanan akademik. <a rel="nofollow" href="https://templatemo.com/page/1" target="_parent"></a>.</p>
