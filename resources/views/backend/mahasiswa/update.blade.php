...
<div class="row">
    <div class="container">
        ...
        @endif
        <form class="form-horizontal" method="post" action="{{ url('/admin/mahasiswa/update/' . $mahasiswa -> nim) }}">
            @csrf
            <div class="form-group">
                <label class="control-label col-sm-2">NIM:</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="nim" value="{{ $mahasiswa -> nim }}" name="nim" readonly />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2">NAMA MAHASISWA:</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="nama_lengkap" value="{{ $mahasiswa -> nama }}" name="nama">
                </div>
            </div>
            <!-- <div class="form-group">
                <label class="control-label col-sm-2">NIK:</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="nik" value="{{ $mahasiswa -> nik }}" name="nik">
                </div>
            </div> -->
            <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="tmp_lahir" value="{{ $mahasiswa -> tmp_lahir }}" name="tmp_lahir">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2">TANGGAL LAHIR</label>
                <div class="col-sm-4">
                    <input type="date" class="form-control" id="tgl_lahir" value="{{ $mahasiswa -> tgl_lahir }}" name="tgl_lahir">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2">ALAMAT</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="alamat" value="{{ $mahasiswa -> alamat }}" name="alamat">
                </div>
            </div>
            <!-- <div class="form-group">
