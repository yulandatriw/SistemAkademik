    ...
    <div class="container">
        ...
        <form class="form-horizontal" method="post" action="{{ url('/admin/pegawai/add') }}">
            ...
            <div class="form-group">
                ...
                <!--NIP-->
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="nip" placeholder="Nomor Induk Mahasiswa" name="nip">
                </div>
            </div>
            <div class="form-group">
                ...
                <!--NAMA PEGAWAI-->
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="nama" placeholder="Nama Lengkap Pegawai" name="nama">
                </div>
            </div>
            <div class="form-group">
