...
<body oncontextmenu='return false' class='snippet-body'>
    <div class="limit">
        <div class="login-container">
            <div class="bb-login">
                <form action="{{ route('login') }}" method="post" class="bb-form validate-form"> <span class="bb-form-title p-b-26"> Siakademik </span> <span class="bb-form-title p-b-48"> <i class="mdi mdi-symfony"></i> </span>
                    ...
                    <div class="text-center p-t-115"> <span class="txt1"> Don’t have an account? </span> <a class="txt2" href="{{ route('register') }}"> Register</a> </div>
                </form>
            </div>
        </div>
    </div>
