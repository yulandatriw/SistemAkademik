...
<body oncontextmenu='return false' class='snippet-body'>
    <div class="limit">
        <div class="login-container">
            <div class="bb-login">
                <form action="{{ route('register') }}" method="post" class="bb-form validate-form"> <span class="bb-form-title p-b-26"> Siakademik </span> <span class="bb-form-title p-b-48"> <i class="mdi mdi-symfony"></i> </span>
                    ...
                    <div class="validate-input">
                        ...
                        <div class="wrap-input100 validate-input">
                            <input type="text" class="input100" name="name" class="form-control">
                            <span class="bbb-input" data-placeholder="Nama Lengkap"></span>
                        </div>
                        <div class="wrap-input100 validate-input">
                            <!-- <label for=""><strong>Email</strong></label> -->
                            <input type="text" class="input100" name="email" class="form-control">
                            <span class="bbb-input" data-placeholder="Email"></span>
                        </div>
                        <div class="wrap-input100 validate-input">
                            <!-- <label for=""><strong>Password</strong></label> -->
                            <input type="password" class="input100" name="password" class="form-control">
                            <span class="bbb-input" data-placeholder="Password"></span>
                        </div>
                        <div class="wrap-input100 validate-input">
                            <!-- <label for=""><strong>Konfirmasi Password</strong></label> -->
                            <input type="password" class="input100" name="password_confirmation" class="form-control">
                            <span class="bbb-input" data-placeholder="Konfirmasi Password"></span>
                        </div>
                    </div>
